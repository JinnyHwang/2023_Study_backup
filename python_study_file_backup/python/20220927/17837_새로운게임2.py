...
while(answer != cnt):
    ...
    for i, h in enumerate(horse):
        ...
        # 이동
            ...
            if color == 1:
                print('red color game_info[y][x]: ', game_info[y][x])
                #print('hl[hi:] :', hl[hi:])
                #print('hl[hi::-1] :', hl[hi::-1])
                #print('hl[:hi-1:-1] :', hl[:hi-1:-1])
                if hi == 0:
                    print('hl[::-1] :', hl[::-1])
                    horse_list = hl[::-1]
                else:
            ...
            # 흰색
                ...
                print('white color game_info[y][x]: ', game_info[y][x])
                print('hl[hi:] :', hl[hi:])
                horse_list = hl[hi:]
            #-------------------------------------------------------------------#
        ...
        #print('[1] game_info[ny][nx] id: ',id(game_info[ny][nx]))
        #print('horse_list id: ', horse_list)
        # 이동
        #game_info[ny][nx] += horse_list
        game_info[ny][nx].extend(horse_list)
        #game_info[ny][nx] = game_info[ny][nx][:] + horse_list
        #print('[2] game_info[ny][nx] id: ',id(game_info[ny][nx]))
        #print('horse_list id: ', horse_list)
        print('game_info[ny][nx]: ', game_info[ny][nx])
        
        if len(game_info[ny][nx]) >= 4:
            answer = cnt
            print('for문 end!  answer: ', answer)
            break
