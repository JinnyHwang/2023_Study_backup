...
def find_remove_tree(y, x, tree_map, toxic_map, k, c):
...
while turn:
    ...
    for y in range(n):
        for x in range(n):
            if tree_map_copy[y][x] > 0:
                ...
                for nt in next_tree:
                    if tree_cnt > 0:
                        tree_map[nt[0]][nt[1]] += tree_map_copy[y][x]//tree_cnt
    ...
    # max_tree, max_pos
    find_remove_tree(max_pos[0], max_pos[1], tree_map, toxic_map, k, c)
