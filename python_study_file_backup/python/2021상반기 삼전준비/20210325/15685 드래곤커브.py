...
#testlist.append(a)
#print("test print1 : ", testlist)

# testlist.reverse() -> list 순서를 뒤섞어주는 역할

# testlist.append( reversed(testlist) )
# [3, <list_reverseiterator object at 0x000002CC3A2BA780>]

# testlist.append( list(reversed(testlist)) )
# [3, [3]]

#print( reversed(testlist[0]) )

#print("test print2 : ", testlist)
